...
slider.oninput = function() {
  ...
  let i = 0;
  for( i = 0 ; i<=n ; i++) {
    document.querySelectorAll(".section")[i].classList.remove("disabled");
  }

  for(let y=10 ; y > n ; y--) {
    document.querySelectorAll(".section")[y-1].classList.add("disabled");
    let disabledNumber = parseInt(document.querySelectorAll(".disabled").length);
